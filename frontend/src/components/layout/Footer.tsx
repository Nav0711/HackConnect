...
const footerLinks = {
  product: [
    { label: "Explore Hackathons", href: "/explore" },
    { label: "Find Teams", href: "/teams/lobby" },
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8">
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <p className="text-sm text-muted-foreground mb-4">
              The ultimate platform for hackathon discovery, team building, and project showcase.
            </p>
